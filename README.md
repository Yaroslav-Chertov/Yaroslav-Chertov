...
### О себе:
С университетских лет занимался созданием сайтов на CMS и No-code (WordPress, Joomla, Tilda). Последние два года занимаюсь проектной деятельностью. Делаю frontend часть сайтов и веб-приложений (HTML, CSS, JS и React JS, Vue.js + остальные инструменты, в зависимости от задач).
