...
### О себе:
Последние два года занимаюсь проектной деятельностью. Делаю frontend часть сайтов и веб-приложений. Чаще всего это HTML, CSS/SASS, JS, React JS или Vue.js + остальные инструменты, в зависимости от задачи.
