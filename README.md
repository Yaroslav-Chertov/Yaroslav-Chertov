...
### О себе:
Фронтенд-разработчик с опытом работы в крупнейшем digital-агентстве. В своей работе использую HTML, CSS/SASS, JavaScript, React.js или Vue.js в зависимости от задач проекта и ТЗ. 

Кроме того, у меня есть интересный опыт в смежных областях:

- Аккаунт-менеджер в digital агентстве - ONY, специализирующемся на UX/UI-дизайне и веб-разработке;
- New Business Manager в VK и AVITO.

Это дало мне понимание полного цикла разработки цифрового продукта и навыки эффективного взаимодействия как с заказчиком, так и с командой.
