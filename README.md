...
### О себе:
Фронтенд-разработчик с опытом работы в крупнейшем digital-агентстве. Разрабатываю интерфейсы для сайтов и веб-приложений, используя HTML, CSS/SASS, JavaScript, React.js или Vue.js в зависимости от задач проекта.

Кроме того, у меня есть интересный опыт в смежных областях: 
- Аккаунт-менеджер в крупнейшем digital агентстве - ONY, специализирующемся на UX/UI-дизайне и веб-разработке;
- New Business Manager в VK и AVITO.

Это дало мне понимание полного цикла разработки продукта и навыки эффективного взаимодействия как с заказчиком, так и с командой.

В свободное время люблю кататься на велосипеде, путешествовать и заниматься резьбой по дереву.
