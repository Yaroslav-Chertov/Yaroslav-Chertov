...
### О себе:
С университетских лет занимался сайтов на CMS и No-code (WordPress, Joomla, Tilda).

Последние два года занимаюсь проектной деятельностью. Делаю frontend часть сайтов и веб-приложений (HTML, CSS, JS и React JS + остальные инструменты, в зависимости от задач).
