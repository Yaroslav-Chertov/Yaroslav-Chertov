...
Фронтенд-разработчик с опытом создания анимационных и SSR-проектов на Node.js / JSX Loader. Специализируюсь на кастомной вёрстке, скролл-анимациях и интеграции с CMS через API. Также c опытом разработки SPA на React и Vue. 

Ранее работал аккаунт-менеджером в digital. Это дало мне ценное понимание полного цикла разработки и общения с руководителями крупных компаний.
